...
import dode2.numericalc as numericalc
import dode2.symmetry as symmetry
import dode2.utils as utils
import dode2.occupation_domain as od
import dode2.projection12 as prj
#except ImportError:
#    print('import error\n')
...
def intersection(obj1,obj2,select='standard',verbose=0):
    ...
    if obj1.ndim==4 and obj2.ndim==4:
        common=intsct.intersection_two_obj_1(obj1,obj2,select,verbose)
