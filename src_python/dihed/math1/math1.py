...
#from numeric.qnmath import mul
#
...
if __name__ == '__main__':
    ...
    for _ in range(ncycle):
        ...
        a=nv1*nconst
        v=v1*const  #mul_vector(v1,const)
    ...
    for _ in range(ncycle):
        ...
        mvs=vs*const  #mul_vectors(vs,const)
