...
od.write_xyz(obj=vtx, path='./example5', basename='common_od_asym', select='vertex')
...
od.write_podatm(obj=vtx, position=EC, vlist=vlst, path='./example5', basename='common_od_asym', verbose=1)
