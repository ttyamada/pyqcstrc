...
from pyqcstrc.icosah.modeling.math1 cimport centroid, coplanar_check, projection, det_matrix, dot_product, add, sub, mul, div
from pyqcstrc.icosah.modeling.numericalc cimport obj_volume_6d_numerical, tetrahedron_volume_6d_numerical, inside_outside_tetrahedron
from pyqcstrc.icosah.modeling.utils cimport obj_volume_6d, tetrahedron_volume_6d, remove_doubling_dim3_in_perp_space
...
@cython.boundscheck(False)
@cython.wraparound(False)
cpdef np.ndarray tetrahedralization_points(np.ndarray[DTYPE_int_t, ndim=3] points, int verbose):
