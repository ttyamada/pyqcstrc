...
def intersection(obj1,obj2,select='standard',verbose=0):
    ...
    if obj1.ndim==4 and obj2.ndim==4:
        common=its.intersection_two_obj_1(obj1,obj2,select,verbose)
...
def intersection_convex(obj1,obj2,verbose=0):
    ...
    """
    if obj1.ndim==4 and obj2.ndim==4:
        common=its.intersection_two_obj_convex(obj1,obj2)
        if np.all(common==None):
            if verbose>0:
                print('no common part')
            return 
...
def subtraction(obj1,obj2,verbose=0):
    ...
    if obj1.ndim==4 and obj2.ndim==4:
        return its.subtraction_two_obj(obj1,obj2,verbose)
    else:
        if verbose>0:
            print('incorrect ndim')
        return 
