...
# つくられたwhlファイルはpip3でインストールできる.
#pip3 install ./dist/pyqcstrc-2021.2-cp39-cp39-macosx_10_14_x86_64.whl
...
#pip3 install --no-cache-dir --index-url https://test.pypi.org/simple/ pyqcstrc
#pip3 install --no-cache-dir --upgrade pyqcstrc