...
cpdef np.ndarray intersection_two_obj_2(np.ndarray[DTYPE_int_t, ndim=4],
                                        np.ndarray[DTYPE_int_t, ndim=4],
                                        int)

cpdef np.ndarray intersection_two_obj_3(np.ndarray[DTYPE_int_t, ndim=4],
                                        np.ndarray[DTYPE_int_t, ndim=4],
                                        int)
...
cpdef double distance_in_perp_space(np.ndarray[DTYPE_int_t, ndim=2],
                             np.ndarray[DTYPE_int_t, ndim=2])
